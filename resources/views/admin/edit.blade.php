                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-8">
                                <select type="text" name="jns_tinggal" id="Jenis Tinggal" class="form-control">
                                    <option value="" {{ ($data->jns_tinggal === "") ? 'selected' :'' }}>-- Pilih --</option>
                                    <option value="Bersama Orang Tua" {{ ($data->jns_tinggal === "Bersama Orang Tua") ? 'selected' :'' }}>Bersama Orang Tua</option>
                                    <option value="Asrama" {{ ($data->jns_tinggal === "Asrama") ? 'selected' :'' }}>Asrama</option>
                                </select>
                            </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="col-sm-4">
                                            <center>
                                                <img src="{{ asset('vendor/foto/'.$data->foto) }}" alt="Profil" style="width: 100px">
                                            </center>
                                        </div>
                                    </div>
                                </div>
